...
; v1.7
; -----
; 1. Fixed scanlines not showing in native screens.
;
EnableExplicit
...
Procedure Load_Prefs()
  ...
  If ReadFile(0,Home_Path+"DD_LAUNCH.prefs")
    While Not Eof(0)
      input$=ReadString(0)
...
Procedure Draw_Gadgets()
  ...
  MenuItem(#MenuItem_14, "Fullscreen")
...
If FileSize(".\Configurations\")=-2
  ...
  If FileSize(Home_Path+"DDLAUNCH.prefs")=-1 : Save_Prefs() : EndIf
